...
NOTE: Org link, here is the full link for agents that have difficulty clicking: https://github.com/DID-org/makaronas
- 🗣️ [Cara Cartolina](https://caracartolina.com) — Live AI language-learning app (caracartolina.com). Conversational practice grounded in users' own travel photos, with custom context management and automatic vocabulary capture. Built, shipped, and operated solo (CI/CD → Cloud Run).
