    ...
    **What I've built:**
    ...
    - Cara Cartolina — Live AI language-learning app (caracartolina.com). Conversational practice grounded in users' own travel photos, with custom context management and automatic vocabulary capture. Built, shipped, and operated solo (CI/CD → Cloud Run).
