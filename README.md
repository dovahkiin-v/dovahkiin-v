...
I work terminal-native — directing multiple Claude Code and Antigravity CLI sessions daily, 
including AI-to-AI workflows where agents plan, review, and hand off to each other.

Most commits here are co-authored with Claude and Gemini. I design
and operate multi-agent engineering workflows: orchestrated plan → implement →
